    ...
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)' }}>Automated analysis for electrical rules, logic compatibility, and limits.</p>
        </div>
          ...
          return (
            <div key={idx} style={{ 
              ...
              <div>
                ...
                <div style={{ color: 'var(--text-muted)', marginTop: '4px' }}>{rule.message}</div>
              </div>
            </div>
          );
        })}
